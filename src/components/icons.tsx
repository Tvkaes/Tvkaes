export const LinkedInIcon = ({ className = 'h-4 w-4 text-[#0A66C2]' }: { className?: string } = {}) => (
...
export const GitHubIcon = ({ className = 'h-4 w-4 fill-current' }: { className?: string } = {}) => (
  <svg viewBox="0 0 24 24" className={className} aria-hidden="true">
    <path
      fillRule="evenodd"
...
export const GlobeIcon = ({ className = 'h-4 w-4 fill-current' }: { className?: string } = {}) => (
  <svg viewBox="0 0 24 24" className={className} aria-hidden="true">
    <path
      fillRule="evenodd"
